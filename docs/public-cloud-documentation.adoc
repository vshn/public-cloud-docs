...
= vshn-public-cloud-documentation(1)
:manname: public-cloud-documentation
:mantitle: Public Cloud Documentation
:leveloffset: +1
endif::[]
...
:doctitle: Public Cloud Documentation
:producer: VSHN AG
:creator: VSHNeer
:description: A description for your e-book
:keywords: VSHN, Antora, e-book, PDF, EPUB, Kindle
