...
pdf:     $(out_dir)/public-cloud-documentation.pdf
manpage: $(out_dir)/public-cloud-documentation.1
epub:    $(out_dir)/public-cloud-documentation.epub
kindle:  $(out_dir)/public-cloud-documentation-kf8.epub
